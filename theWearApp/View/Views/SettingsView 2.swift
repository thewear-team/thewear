...
class SettingsView: UIView {
    ...
    func configureWeather() {
        ...
        pressure.anchor(windSpeed.bottomAnchor, nil, nil, trailingAnchor, 10, nil, nil, 30, Frames.shared.height * 0.1, Frames.shared.height * 0.05)
        pressureLabel.anchor(windSpeedLabel.bottomAnchor, leadingAnchor, nil, pressure.leadingAnchor, 10, 30, nil, 30, nil, Frames.shared.height * 0.05)
    }
