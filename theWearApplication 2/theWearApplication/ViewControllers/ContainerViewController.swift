...
class ContainerViewController: UIViewController {
    ...
    func animateSearchCitiesViewController(_ currentCity: String) {
        if searchIsOpened {
            UIView.animate(withDuration: 0.9, delay: 0, usingSpringWithDamping: 2, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
            ...
            searchCitiesViewController.delegate = self
            searchCitiesViewController.currentCity = currentCity
            ...
            UIView.animate(withDuration: 0.9, delay: 0, usingSpringWithDamping: 2, initialSpringVelocity: 1, options: .curveEaseOut, animations: {
                ...
                self.searchCitiesViewController.searchTextField.becomeFirstResponder()
            })
        }
    ...
    @objc func handlePanOfSearchCitiesViewController(_ recognizer: UIPanGestureRecognizer) {
        if recognizer.state == .began {
            searchCitiesViewController.searchTextField.resignFirstResponder()
