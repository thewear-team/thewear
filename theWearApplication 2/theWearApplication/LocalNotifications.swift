...
var hourOfNotification : Int = 00
var minuteOfNotification : Int = 36
...
func createNotificationAtTime(){
    ...
    dateComponents.hour = hourOfNotification
    dateComponents.minute = minuteOfNotification
    ...
    case 0...18:
        if UserDefaults.standard.value(forKey: "daysParts") != nil{
            ...
            if status != "partly cloudy"{
                text = "Today: \(status) possible, the average temperature is \(temp). \(windAlert) \(UVAlert) \(clothes)"}
            else {
